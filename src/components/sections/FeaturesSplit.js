          ...
          <div className={splitClasses}>
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                ...
                <p className="m-0">
                    As the pandemic continues to change the lifestyle of many students, it is evident that the collaborative work between students in the classroom has been greatly affected through online schooling. As such, I decided to program a Study Bot which enables students to work together and study efficiently through the popular platform Discord. This StudyBot utilizes the Discord.py API integrated along with SQL to create databases for question banks for students to study. Along with various API’s to enable features such as built in Wikipedia summaries, dictionaries and language translators, this bot ensures an increase in efficiency of students studying in an online environment! 
                </p>
              </div>
              <div className={
                classNames(
